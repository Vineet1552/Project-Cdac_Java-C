...
//    private PackageEntity packageEntity;
//
//    // Use LocalDateTime for precise slot scheduling
//    @NotNull(message = "Booking date/time is required")
//    @FutureOrPresent(message = "Booking date/time must be now or in the future")
//    @Column(name = "booking_date", nullable = false)
...
//    private String remarks;
//
//    // Snapshot fields (store the package price and name at booking time)
//    @Column(name = "price_at_booking")
//    private Double priceAtBooking;
//
//    @Column(name = "package_name_at_booking")
//    private String packageNameAtBooking;
//
//    // Payment relation — optional to avoid create-time failures
